...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = $pdo->prepare("CREATE TABLE  IF NOT EXISTS `chat_message_cpmvj` (
     ...
     `chat_message_status` text CHECK( chat_message_status IN ('No','Yes') )  NOT NULL ,
    ...
    `chat_request_status` text CHECK( chat_request_status IN ('Send','Accept','Reject') )  NOT NULL,
