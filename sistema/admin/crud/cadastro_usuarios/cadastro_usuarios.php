...
if (isset($_REQUEST["act"]) && $_REQUEST["act"] == "save" && $nome != "" && $_REQUEST["nivel"] != "representante") {
    try {
        if ($id != "") {
            ...
            $stmt = $conexao->prepare("INSERT INTO usuarios (nome, sobrenome, usuario, telefone, email, email_cliente,  senha, nivel, prazo, imagem, cadastro, token) VALUES (?, ?, ?, ?, ?, ?, ?,?, 'indeterminado', ? , date('now'), ?)");
        }
...
if (isset($_REQUEST["act"]) && $_REQUEST["act"] == "save" && $nome != "" && $_REQUEST["nivel"] == "representante") {
    try {
        ...
        if ($id != "") {
            ...
            $stmt = $conexao->prepare("INSERT INTO login_representantes (nome, usuario,imagem, senha,cadastro,nivel) VALUES (?, ?, ?, ?, date('now'),?)");
        }
        $stmt->bindParam(1, $nome);
...
<div class="site-cols-wrapper">
  ...
  <div class="site-left-col-inner">
          ...
          <div class=" m-b-16" >
            ...
            <label >NOME</label>
             <div class="controls">
            <input class="input100" type="text" name="nome" value="" class="form-control"/>
          </div></div></div>
          ...
          <div class=" m-b-16" >
            ...
            <label >SOBRENOME</label>
             <div class="controls">
            <input class="input100" type="text" name="sobrenome" value="" class="form-control"/>
          </div></div></div>
          ...
          <div class=" m-b-16" >
            ...
            <label >EMAIL</label>
             <div class="controls">
            <input class="input100" type="text" name="email" value="" class="form-control"/>
          </div></div></div>
          ...
          <div class=" m-b-16" >
            ...
            <label >SENHA</label>
             <div class="controls">
            <input class="input100" type="text" name="senha" value="" class="form-control" />
          </div></div></div>
  ...
  <div class="site-left-col-inner">
    <!-- =====   NÍVEL DE ACESSO ======   -->
          ...
          <div class=" m-b-16" >
            ...
            <label >USUÁRIO</label>
             <div class="controls">
            <input class="input100" type="text" name="usuario" value="" class="form-control" />
          </div></div></div>
          ...
          <div class=" m-b-16" >
            ...
            <label >TELEFONE</label>
             <div class="controls">
            <input class="input100" type="text" name="telefone" value="" class="form-control"/>
          </div></div></div>
